...
public class CraveStatusBarView extends FrameLayout implements View.OnClickListener {
	...
	private void loadDefaultComponents() {
		...
		btnBack.setInfo(NavbarEditor.NAVBAR_BACK, false, false);
		...
		btnHome.setInfo(NavbarEditor.NAVBAR_HOME, false, false);
